...
if [ -z "$LAYOUT_NAME" ]; then
    ...
    echo " - The unicode variant sends all keys using the unicode shortcut (usually Ctrl+Shift+U+<0-F>). This layout is the most resistant to overbinding of keys but sends multiple keys instead of just one, unnecessarily heavy if you do not need it."
    echo
