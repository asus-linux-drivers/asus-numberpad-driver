...
def mod_name_to_specific_keysym_name(mod_name):
    global display_wayland, kde_current_layout_index, gnome_current_layout_index, keyboard_state
...
def send_value_to_touchpad_via_i2c(value):
    ...
    try:
        ...
        log.error("periphery.I2C failed: %s", e)
...
while try_times > 0:
    ...
    with open('/proc/bus/input/devices', 'r') as f:
        ...
        for line in lines:
            ...
            # https://github.com/asus-linux-drivers/asus-numberpad-driver/pull/309
            if (touchpad_detected == 0 and ("Name=\"ASUE" in line or "Name=\"ELAN" in line or "Name=\"ASUP" in line or "Name=\"ASUF" in line or "Name=\"ASCP" in line or "Name=\"ASCF" in line) and "Touchpad" in line and not "9009" in line and not "9008" in line):
                touchpad_detected = 1
            ...
            if keyboard_detected == 0 and ("Name=\"AT Translated Set 2 keyboard" in line or (("Name=\"ASUE" in line or "Name=\"Asus" in line or "Name=\"ASUP" in line or "Name=\"ASUF" in line or "Name=\"ASCP" in line or "Name=\"ASCF" in line) and "Keyboard" in line)):
                keyboard_detected = 1
                log.info(
