...
[![GitHub commits](https://img.shields.io/github/commits-since/asus-linux-drivers/asus-numberpad-driver/v5.1.1.svg)](https://GitHub.com/asus-linux-drivers/asus-numberpad-driver/commit/)
...
| `top_left_icon_slide_func_activation_x_ratio` |          | `0.2` (20%)         | ratio of minimum width of slide to Touchpad width
| `top_left_icon_slide_func_activation_y_ratio` |          | `0.2` (30%)         | ratio of minimum height of slide to Touchpad height
...
| `top_right_icon_slide_func_activation_x_ratio`|          | `0.2` (20%)         | ratio of minimum width of slide to Touchpad width
| `top_right_icon_slide_func_activation_y_ratio`|          | `0.2` (30%)         | ratio of minimum height of slide to Touchpad height
**Backlight**                                   |          |                   |
