...
[![GitHub commits](https://img.shields.io/github/commits-since/asus-linux-drivers/asus-touchpad-numpad-driver/v1.3.0.svg)](https://GitHub.com/asus-linux-drivers/asus-touchpad-numpad-driver/commit/)
...
- Customization through 2-way sync [configuration file](https://github.com/asus-linux-drivers/asus-touchpad-numpad-driver#configuration-file) (when running `sudo ./install` twice changes done in config file are not ovewritten)
